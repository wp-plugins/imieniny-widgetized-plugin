...
Plugin URI: http://konicki.com/blog2/downloads/imieniny-wordpress-plugin/
...
$imieniny = array( "1-1" => 'Mieczysław, Masław,<BR> Mieczysława, Mieszko',
							...
							"3-25" => 'Dyzma, Ireneusz, Lucja, Lutomysł, Łucja, Maria, Mariola, Wieńczysław',
							...
							"4-19" => 'Adolf, Adolfa, Adolfina, Alf, Cieszyrad, Czesław, Czech, Czechasz, Czechoń, Leon, Leontyna, Pafnucy, Tymon, Werner, Włodzimierz',
							"4-20" => 'Agnieszka, Amalia, Czesław, Czech, Czechasz, Czechoń, Florencjusz, Florenty, Nawoj, Sulpicjusz, Szymon, Teodor',
							...
							"5-14" => 'Bonifacy, Bończa, Dobiesław, Jeremiasz, Jeremi, Wiktor, Wiktoriusz',
							"5-15" => 'Atanazy, Afanazy, Berta, Cecyliusz, Czcibora, Dionizja, Izydor, Jan, Nadzieja, Ruprecht, Strzeżysław, Zofia',
							"5-16" => 'Andrzej, Honorat, Jan Nepomucen, Jędrzej, Szymon, Trzebomysł, Ubald, Wieńczysław, Wiktorian',
							...
							"6-5" => 'Bonifacy, Bończa, Dobrociech, Dobromir, Dobrymir, Nikanor, Waleria, Walter',
							...
							"7-20" => 'Czesław, Czech, Czechasz, Czechoń, Eliasz, Heliasz, Hieronim, Leon, Małgorzata, Paweł, Sewera',
							...
							"9-2" => 'Absalon, Bohdan, Czesław, Czech, Czechasz, Czechoń, Dersław, Dionizy, Eliza, Henryk, Julian, Stefan, Tobiasz, Wilhelm, Witomysł',
							...
							"10-25" => 'Bonifacy, Bończa, Chryzant, Daria, Inga, Kryspin, Maur, Sambor, Taras, Teodozjusz, Wilhelmina',
...
// Options form for the widget - called in the Sidebar Widgets of the Presentation tab
	...
	// The control form for editing options.        
        ...
        echo '<div>';
        echo '<label for="imieniny-title">' . _('Widget title:') . ' <input style="width: 200px;" type="text" id="imieniny-title" name="imieniny-title" value="'.$title.'" /></label>';
	echo '<br />';
	echo '<br />';	
	echo 'The current server time is: ' . date("F d, Y H:i:s", time()); 
	echo '<br />';	
	echo '<br />';
        echo '<label for="imieniny-tdiff">' . _('Time differential (e.g., -5, +3, etc.):') . ' <input input style="width: 100px;" type="text" id="imieniny-tdiff" name="imieniny-tdiff" value="'.$tdiff.'" /></label>';
